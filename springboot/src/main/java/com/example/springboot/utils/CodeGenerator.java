...
public class CodeGenerator {
    ...
    // 数据库名称
    private static final String DATASOURCE = "jiayou";
    
    // 你自己的项目路径，一定要改成你自己的！！结尾必须是:  \\springboot\\
    private static final String basePath = "E:\\BaiduNetdiskDownload\\毕业设计集合\\112-加油站系统\\springboot\\";

    // 数据库需要生成代码的表名
    private static final String tableName = "gas";
    // 生成页面的菜单名称
    private static final String modelName = "汽油管理";
    ...
    private static void createVue(String tableName) throws Exception {
        ...
        for (TableColumn tableColumn : tableColumns) {
            ...
            if (tableColumn.getName().contains("time")) {
                ...
                // 文件上传
                formBuilder.append(space10).append("<el-upload action=\"http://localhost:8888/file/upload\" ref=\"file\" :on-success=\"handleFileUploadSuccess\">\n");
                ...
                // 文件上传
                formBuilder.append(space10).append("<el-upload action=\"http://localhost:8888/file/upload\" ref=\"img\" :on-success=\"handleImgUploadSuccess\">\n");
                formBuilder.append(space10).append("  <el-button size=\"small\" type=\"primary\">点击上传</el-button>\n");
                formBuilder.append(space10).append("</el-upload>\n");
            } else {
